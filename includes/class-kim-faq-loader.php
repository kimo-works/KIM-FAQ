...
class kim_faq_Loader {
	...
	public function add_shortcode( $tag, $callback ) {
		$this->shortcodes = $this->shortcode( $tag, $callback );
	}

	private function shortcode(  $tag,  $callback ) {
		$hooks[] = array(
			'tag'          => $tag,
			'callback'      => $callback,
	...
	/**
	 * Register the filters and actions and shortcode  with WordPress.
	 *
	 * @since    1.0.0
	 */
	public function run() {
